...
export function AppleMusicIcon({ size = 24, className }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      {/* Eighth-note shape — the Apple Music brand symbol */}
      <ellipse cx="8.5" cy="18.5" rx="3" ry="2" />
      <rect x="11" y="4.5" width="1.5" height="14" />
      <path d="M12.5 4.5 L20 2 L20 7.5 L12.5 10 Z" />
    </svg>
  )
}
